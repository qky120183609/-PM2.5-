...
select 
    ...
    avg(avg_pm_cn1) as city_station,
    avg(avg_pm_cn2) as fifth_middle_school,
    avg(avg_pm_us) as us
from tb_daily_stats
where city_id = 4
...
ax.plot(months, df['city_station'], marker='o', label='城市车站', linewidth=2)
ax.plot(months, df['fifth_middle_school'], marker='s', label='第五中学', linewidth=2)
